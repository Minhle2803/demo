                            ...
                            <div class="mt-3 mt-lg-0">
                                <form action="javascript:void(0);">
                                    <div class="row g-3 mb-0 align-items-center">
                                        <div class="col-sm-auto">
                                            <div class="input-group">
                                                <input
                                                    ...
                                                    data-provider="flatpickr" data-range-date="true" type="text" />
                                        ...
                                        <!--end col-->
                                        <div class="col-auto">
                                            <button class="btn btn-soft-success material-shadow-none" type="button"><i
                                        ...
                                        <div class="col-auto">
                                            <button
                                                ...
                                                type="button"><i class="ri-pulse-line"></i></button>
                                        </div>
                                        <!--end col-->
                                    </div>
                                    <!--end row-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a class="text-decoration-underline" href="#">View net earnings</a>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a class="text-decoration-underline" href="#">View all orders</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a class="text-decoration-underline" href="#">See details</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a class="text-decoration-underline" href="#">Withdraw money</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-header border-0 align-items-center d-flex">
                                ...
                                <div>
                                    <button class="btn btn-soft-secondary material-shadow-none btn-sm" type="button">
                                        ALL
                                    </button>
                                    <button class="btn btn-soft-secondary material-shadow-none btn-sm" type="button">
                                        1M
                                    ...
                                    <button class="btn btn-soft-primary material-shadow-none btn-sm" type="button">
                                        1Y
                                    </button>
                                </div>
                            </div><!-- end card header -->
                            ...
                            <div class="card-body p-0 pb-2">
                                <div class="w-100">
                                    <div class="apex-charts" data-colors='["--vz-primary", "--vz-success", "--vz-danger"]'
                                        ...
                                        data-colors-vintage='["--vz-success", "--vz-primary", "--vz-secondary"]' dir="ltr"
                                        id="customer_impression_charts"></div>
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-xl-4">
                        ...
                        <div class="card card-height-100">
                            ...
                            <!-- card body -->
                            <div class="card-body">
                                <div data-colors='["--vz-light", "--vz-success", "--vz-primary"]'
                                    data-colors-interactive='["--vz-light", "--vz-info", "--vz-primary"]' dir="ltr"
                                    id="sales-by-locations" style="height: 269px"></div>
                                <div class="px-2 py-2 mt-1">
                                    <p class="mb-1">Canada <span class="float-end">75%</span></p>
                                    <div class="progress mt-2" style="height: 6px;">
                                        <div aria-valuemax="75" aria-valuemin="0" aria-valuenow="75"
                                    ...
                                    <div class="progress mt-2" style="height: 6px;">
                                        <div aria-valuemax="47" aria-valuemin="0" aria-valuenow="47"
                                            class="progress-bar progress-bar-striped bg-primary" role="progressbar"
                                            style="width: 47%"></div>
                                    </div>
                                    <p class="mt-3 mb-1">Russia <span class="float-end">82%</span></p>
                                    <div class="progress mt-2" style="height: 6px;">
                                        <div aria-valuemax="82" aria-valuemin="0" aria-valuenow="82"
                                            class="progress-bar progress-bar-striped bg-primary" role="progressbar"
                                            style="width: 82%"></div>
                                    </div>
                                </div>
                            ...
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="text-reset dropdown-btn"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1"><a class="text-reset"
                                                                    href="apps-ecommerce-product-details.html">Branded
                                                                    T-Shirts</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1"><a class="text-reset"
                                                                    href="apps-ecommerce-product-details.html">Bentwood
                                                                    Chair</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1"><a class="text-reset"
                                                                    href="apps-ecommerce-product-details.html">Borosil Paper
                                                                    Cup</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1"><a class="text-reset"
                                                                    href="apps-ecommerce-product-details.html">One Seater
                                                                    Sofa</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1"><a class="text-reset"
                                                                    href="apps-ecommerce-product-details.html">Stillbird
                                                                    Helmet</a></h5>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1 fw-medium">
                                                                <a class="text-reset"
                                                                    href="apps-ecommerce-seller-details.html">iTest
                                                                    Factory</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 my-1 fw-medium"><a class="text-reset"
                                                                    href="apps-ecommerce-seller-details.html">Digitech
                                                                    Galaxy</a></h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-gow-1">
                                                            <h5 class="fs-14 my-1 fw-medium"><a class="text-reset"
                                                                    href="apps-ecommerce-seller-details.html">Nesta
                                                                    Technologies</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 my-1 fw-medium"><a class="text-reset"
                                                                    href="apps-ecommerce-seller-details.html">Zoetic
                                                                    Fashion</a></h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 my-1 fw-medium">
                                                                <a class="text-reset"
                                                                    href="apps-ecommerce-seller-details.html">Meta4Systems</a>
                                                            </h5>
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body">
                                <div class="apex-charts"
                                    ...
                                    dir="ltr" id="store-visits-source"></div>
                            </div>
                        </div> <!-- .card-->
                    </div> <!-- .col-->
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <button class="btn btn-soft-info btn-sm material-shadow-none" type="button">
                                    ...
                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <a class="fw-medium link-primary"
                                                        href="apps-ecommerce-order-details.html">#VZ2112</a>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img alt="" class="avatar-xs rounded-circle material-shadow"
                                            ...
                                            <tr>
                                                <td>
                                                    <a class="fw-medium link-primary"
                                                        href="apps-ecommerce-order-details.html">#VZ2111</a>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <a class="fw-medium link-primary"
                                                        href="apps-ecommerce-order-details.html">#VZ2109</a>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <a class="fw-medium link-primary"
                                                        href="apps-ecommerce-order-details.html">#VZ2108</a>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <a class="fw-medium link-primary"
                                                        href="apps-ecommerce-order-details.html">#VZ2107</a>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
            ...
            <div class="layout-rightside">
                <div class="card h-100 rounded-0">
                    <div class="card-body p-0">
                        ...
                        <div class="p-3 pt-0" data-simplebar="" style="max-height: 410px;">
                            <div class="acitivity-timeline acitivity-main">
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                            <a class="bg-light rounded p-1" href="apps-ecommerce-product-details.html">
                                                <img alt="" class="img-fluid d-block"
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    <div class="flex-shrink-0">
                                        <img alt="" class="avatar-xs rounded-circle acitivity-avatar material-shadow"
                                            src="{{ asset('assets/images/users/avatar-2.jpg') }}" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 lh-base">Today offers by <a class="link-secondary"
                                                href="apps-ecommerce-seller-details.html">Digitech Galaxy</a></h6>
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted mb-0">Flash sale by <a class="link-secondary fw-medium"
                                                href="javascript:void(0);">Zoetic Fashion</a></p>
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted mb-2"><span class="text-danger">2 days left</span> notification
                                            to submit the monthly sales report. <a
                                                class="link-warning text-decoration-underline"
                                                href="javascript:void(0);">Reports Builder</a></p>
                        ...
                        <div class="p-3 mt-2">
                            ...
                            <ol class="ps-3 text-muted">
                                <li class="py-1">
                                    <a class="text-muted" href="#">Mobile &amp; Accessories <span
                                            class="float-end">(10,294)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Desktop <span class="float-end">(6,256)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Electronics <span class="float-end">(3,479)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Home &amp; Furniture <span
                                            class="float-end">(2,275)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Grocery <span class="float-end">(1,950)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Fashion <span class="float-end">(1,582)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Appliances <span class="float-end">(1,037)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Beauty, Toys &amp; More <span
                                            class="float-end">(924)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Food &amp; Drinks <span
                                            class="float-end">(701)</span></a>
                                </li>
                                <li class="py-1">
                                    <a class="text-muted" href="#">Toys &amp; Games <span class="float-end">(239)</span></a>
                                </li>
                            </ol>
                            <div class="mt-3 text-center">
                                <a class="text-muted text-decoration-underline" href="javascript:void(0);">View all
                                    Categories</a>
                            </div>
                        </div>
                        <div class="p-3">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card border border-dashed shadow-none">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0">
                                                        <img alt="" class="avatar-sm rounded material-shadow"
                                                            src="{{ asset('assets/images/users/avatar-3.jpg') }}" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <div>
                            ...
                            <div class="mt-3">
                                    ...
                                    <div class="col">
                                        <div class="p-1">
                                            <div class="progress animated-progress progress-sm">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50.16"
                                                    class="progress-bar bg-success" role="progressbar"
                                                    style="width: 50.16%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row align-items-center g-2">
                                    ...
                                    <div class="col">
                                        <div class="p-1">
                                            <div class="progress animated-progress progress-sm">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="29.32"
                                                    class="progress-bar bg-success" role="progressbar"
                                                    style="width: 29.32%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row align-items-center g-2">
                                    ...
                                    <div class="col">
                                        <div class="p-1">
                                            <div class="progress animated-progress progress-sm">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="18.12"
                                                    class="progress-bar bg-warning" role="progressbar"
                                                    style="width: 18.12%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row align-items-center g-2">
                                    ...
                                    <div class="col">
                                        <div class="p-1">
                                            <div class="progress animated-progress progress-sm">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="4.98"
                                                    class="progress-bar bg-success" role="progressbar" style="width: 4.98%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row align-items-center g-2">
                                    ...
                                    <div class="col">
                                        <div class="p-1">
                                            <div class="progress animated-progress progress-sm">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="7.42"
                                                    class="progress-bar bg-danger" role="progressbar" style="width: 7.42%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                            <div class="card-body">
                                <img alt="" src="{{ asset('assets/images/giftbox.png') }}" />
                                <div class="mt-4">
                                    <h5>Invite New Seller</h5>
                                    <p class="text-muted lh-base">Refer a new seller to us and earn $100 per refer.</p>
                                    <button class="btn btn-primary btn-label rounded-pill" type="button"><i
