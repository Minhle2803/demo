            ...
            <div class="theme-root dark _CWC common-widget-provider">
               <header class="header-container hidden-in-bnc-app common-widget-css_wrap theme-root bg1 dark-color">
                  <div class="header-leftside menu-aim-enabled">
                     ...
                     <div class="header-menu-item rwd-1024-hide-flex"><a class="header-menu-item_view typography-Subtitle4" id="ba-tableMarkets" href="https://www.binance.com/en/markets/overview">Trading</a></div>
                  </div>
      ...
      <div id="__APP">
         <div class="theme-root dark" style="--color-BasicBg:#181A20;--color-SecondaryBg:#0B0E11;--color-Input:#29313D;--color-InputLine:#434C5A;--color-CardBg:#202630;--color-Vessel:#29313D;--color-Line:#333B47;--color-DisableBtn:#29313D;--color-DisableText:#4F5867;--color-TertiaryText:#707A8A;--color-SecondaryText:#929AA5;--color-PrimaryText:#EAECEF;--color-RedGreenBgText:#FFFFFF;--color-EmphasizeText:#FF693D;--color-TextOnGray:#EAECEF;--color-TextOnYellow:#202630;--color-IconNormal:#707A8A;--color-LiteBg1:#202630;--color-LiteBg2:#191A1F;--color-BtnBg:#FCD535;--color-PrimaryYellow:#F0B90B;--color-TextLink:#F0B90B;--color-TradeBg:#0B0E11;--color-TextToast:#F0B90B;--color-DepthSellBg:#35141D;--color-SellHover:#F6465D;--color-Sell:#F6465D;--color-TextSell:#F6465D;--color-DepthBuyBg:#102821;--color-BuyHover:#2EBD85;--color-Buy:#2EBD85;--color-TextBuy:#2EBD85;--color-Error:#F6465D;--color-SuccessBg:#102821;--color-Success:#2EBD85;--color-TagBg:#434C5A;--color-Grid:#333B47;--color-Placeholder:#434C5A;--color-ToastBg:#4F5867;--color-TwoColorIcon:#CACED3;--color-ErrorBg:rgba(246, 70, 93, 0.1);--color-BadgeBg:rgba(240,185,11,0.1);--color-Popup:#333B47;--color-Mask:rgba(11, 14, 17, 0.6);--color-WidgetSecondaryBg:rgba(195, 207, 240, 0.08);--color-WidgetSurface:rgba(195, 207, 240, 0.06);--color-WidgetSurface2:rgba(122, 148, 178, 0.12);--color-ContainerBg:#29313D;--color-YellowAlpha01:rgba(252, 213, 53, 0.1);--color-YellowAlpha02:rgba(252, 213, 53, 0.2);--color-RedAlpha01:rgba(246, 70, 93, 0.1);--color-RedAlpha02:rgba(246, 70, 93, 0.2);--color-GreenAlpha01:rgba(46, 189, 133, 0.1);--color-GreenAlpha02:rgba(46, 189, 133, 0.2);--color-ChatBg:#1A1E25;--color-LineAlpha:rgba(193, 204, 219, 0.08);--color-WidgetPrimaryBg:rgba(122, 148, 178, 0.08);--color-ChatBubble:#29313D;--color-ChatBubble2:#2D3E59;--color-ChatInput:rgba(41, 49, 61, 0.95);--color-ChatName:#F0B90B;--color-ChatSysMsg:#1C2229;--color-ChatCard:#212731;--color-ChatCard2:#243042;--color-ChatRed:#30222B;--color-ParagraphText:#EAECEF;--color-CheckboxFillDefault:#DFDFDF;--color-CheckboxBorder:rgba(255, 255, 255, 0.3)">
                                          ...
                                          <div class="relative h-full w-full transition-transform duration-700 ease-out text-PrimaryYellow" style="transform-style:preserve-3d;transform:rotateY(0deg)">
                                             <div class="absolute flex h-full w-full items-center justify-center" style="backface-visibility:hidden;-webkit-backface-visibility:hidden;transform:translateZ(1px)">
                                                <div class="w-full text-center">
                                                   <div style="font-weight:700;font-size:28px;line-height:100%">No.1</div>
                                                   <div style="font-weight:500;font-size:16px">Customer Assets</div>
                                                </div>
                                             </div>
                                             <div class="absolute flex h-full w-full items-center justify-center" style="backface-visibility:hidden;-webkit-backface-visibility:hidden;transform:rotateY(180deg) translateZ(1px)">
                                                <div class="w-full text-center">
                                                   <div style="font-weight:700;font-size:28px;line-height:100%">Assets</div>
                                       ...
                                       <div style="perspective:1000px;height:47px;width:160px">
                                          <div class="relative h-full w-full transition-transform duration-700 ease-out text-PrimaryYellow" style="transform-style:preserve-3d;transform:rotateY(0deg)">
                                             <div class="absolute flex h-full w-full items-center justify-center" style="backface-visibility:hidden;-webkit-backface-visibility:hidden;transform:translateZ(1px)">
                                                <div class="w-full text-center">
                                                   <div style="font-weight:700;font-size:28px;line-height:100%">No.1</div>
                                                   <div style="font-weight:500;font-size:16px">Trading Volume</div>
                                                </div>
                                             </div>
                                             <div class="absolute flex h-full w-full items-center justify-center" style="backface-visibility:hidden;-webkit-backface-visibility:hidden;transform:rotateY(180deg) translateZ(1px)">
                                                <div class="w-full text-center">
                                    ...
                                    <div class="mobile:align-center mb-[0px] flex w-full mobile:flex-col gap-s">
                                       @auth('client')
                                        <div class="flex justify-center">
                                            <a href="{{ route('tradding') }}" class="bn-button data-size-large h-[56px] h-full w-[200px] min-w-[2000px] rounded-[8px] px-3xl text-subtitle1 mobile:h-[40px] mobile:min-h-[40px] mobile:min-w-[200px]">Trading</a>
                                        </div>
                                        @else
                                       ...
                                       <div class="hidden mobile:block">
                                        ...
                                        <div class="flex justify-center">
                                            <a href="{{ route('signin') }}" class="bn-button data-size-large h-[56px] h-full w-[180px] min-w-[160px] rounded-[8px] px-3xl text-subtitle1 mobile:h-[40px] mobile:min-h-[40px] mobile:min-w-[160px]">Log In</a>
                                        </div>
                                        @endauth
                                    </div>
                        ...
                        <div class="relative rounded-[20px] mobile:p-0 noH5:px-xl noH5:pb-l noH5:bg-Vessel mobile:bg-transparent mobile:flex-1 mobile:text-center flex flex-col py-[20px] tablet:gap-xs desktop:gap-l noH5:pt-s">
                           <div class="bn-tabs bn-tabs__default coin-list-content relative mobile:gap-[12px] noH5:gap-[16px] desktop:[&amp;&gt;*]:first:my-0">
                              <div role="tablist" aria-orientation="horizontal" class="bn-tab-list bn-tab-list__default">
                                 <div role="tab" aria-selected="true" class="bn-tab bn-tab__default active" id="bn-tab-0" aria-controls="bn-tab-pane-0" tabindex="0">Popular</div>
                                 <div role="tab" aria-selected="false" class="bn-tab bn-tab__default" id="bn-tab-1" aria-controls="bn-tab-pane-1" tabindex="-1">New Listing</div>
                              </div>
                        ...
                        <div class="max-w-7xl mx-auto">
                           <div class="flex" style="gap:44px">
                              <div class="flex flex-col" style="width:572px">
                                 <div>
                                    <div style="font-size:64px;font-style:normal;font-weight:600;line-height:100%;text-transform:uppercase">FUNDS ARE</div>
                                    <div class="text-PrimaryYellow" style="font-size:64px;font-style:normal;font-weight:600;line-height:100%">SAFU</div>
                                 </div>
                                 <div class="t-body3 mt-[8px] w-[480px]">The Security of User Assets Fund (SAFU) was established in 2018 to protect your funds in rare emergencies. Your security is our priority.</div>
                              </div>
                              <div style="display:flex;flex-direction:column;gap:36px">
                                 ...
                                 <div style="display:flex;gap:63px">
                                    <div>
                                       ...
                                       <div class="t-headline5">Users helped</div>
                                    </div>
                                    <div>
                                       <div class="t-headline2 text-PrimaryYellow">$229,433,449</div>
                                       <div class="t-headline5">Funds recovered</div>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="download-pc flex flex-col gap-5xl mobile:hidden mobile:gap-xl tablet:gap-xl">
                           <div class="mt-[0px] flex items-center mobile:mt-4xl">
                              ...
                              <div class="text-PrimaryText ml-xl">
                                 <div class="text-body1 text-t-third mobile:text-body2 tablet:text-body2">Scan to Download App</div>
                                 <div class="mt-2xs text-headline6 mobile:text-subtitle1 tablet:text-subtitle1">iOS and Android</div>
                              </div>
                           </div>
                           <div class="flex w-[436px] justify-between gap-[64px] mobile:w-full mobile:gap-[0px] tablet:w-[336px] tablet:gap-[24px]">
                              <a href="" id="Download_2023_macOS" class="flex w-[112px] cursor-pointer flex-col items-center rounded-[8px] p-2xs mobile:w-auto tablet:w-[96px] hover:bg-[#252A32]">
                                 ...
                                 <div class="mt-2xs text-subtitle1 text-PrimaryText mobile:text-subtitle2 tablet:text-subtitle2">MacOS</div>
                              </a>
                              <a href="" id="Download_2023_windows" class="flex w-[112px] cursor-pointer flex-col items-center rounded-[8px] p-2xs mobile:w-auto tablet:w-[96px] hover:bg-[#252A32]">
                                 ...
                                 <div class="mt-2xs text-subtitle1 text-PrimaryText mobile:text-subtitle2 tablet:text-subtitle2">Windows</div>
                              </a>
                           ...
                           <a id="Download_2023_more" href="/en/download" class="bg-transparent flex h-[48px] w-fit items-center text-PrimaryText hover:text-t-secondary mobile:mt-[40px] mobile:h-[40px]">
                              ...
                              <div class="text-subtitle1 mobile:text-subtitle2 ml-4xs">More Download Options</div>
                           </a>
                        </div>
                     </div>
                  </div>
            ...
            <div class="bg-bg1 smooth_style mobile:py-6 tablet:py-16 py-20">
               <div class="mx-auto mobile:px-m px-xl" style="max-width:1248px">
                  <h2 class="mx-auto mb-[64px] w-fit flex-1 text-center text-headline2 text-PrimaryText mobile:mb-m mobile:text-headline5 tablet:mb-[48px] tablet:text-headline4">Frequently Asked Questions</h2>
                  <div class="faq-item-widget dark  mb-m w-full rounded-[10px] px-xl py-m mobile:bg-inherit last:mb-[0px] mobile:mb-[0px] mobile:px-[0px] mobile:py-[16px]">
                     <div class="flex cursor-pointer items-center ">
                        ...
                        <h2 class="mr-m flex-1 text-headline6 text-PrimaryText mobile:t-subtitle6 mobile:font-normal">Why is Binance the best exchange for crypto traders?</h2>
                        <div>
                  ...
                  <div class="faq-item-widget dark  mb-m w-full rounded-[10px] px-xl py-m mobile:bg-inherit last:mb-[0px] mobile:mb-[0px] mobile:px-[0px] mobile:py-[16px]">
                     <div class="flex cursor-pointer items-center ">
                        ...
                        <h2 class="mr-m flex-1 text-headline6 text-PrimaryText mobile:t-subtitle6 mobile:font-normal">What products does Binance provide?</h2>
                        <div>
                           <svg class="bn-svg mobile:mx-[8px]" style="font-size:20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1 19.5v-6.6H4.5a.9.9 0 010-1.8h6.6V4.5a.9.9 0 011.8 0v6.6h6.6l.092.005a.9.9 0 010 1.79l-.092.005h-6.6v6.6a.9.9 0 01-1.8 0z" fill="currentColor"></path>
                           </svg>
                  ...
                  <div class="faq-item-widget dark  mb-m w-full rounded-[10px] px-xl py-m mobile:bg-inherit last:mb-[0px] mobile:mb-[0px] mobile:px-[0px] mobile:py-[16px]">
                     <div class="flex cursor-pointer items-center ">
                        ...
                        <h2 class="mr-m flex-1 text-headline6 text-PrimaryText mobile:t-subtitle6 mobile:font-normal">How to buy Bitcoin and other cryptocurrencies on Binance</h2>
                        <div>
                           <svg class="bn-svg mobile:mx-[8px]" style="font-size:20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1 19.5v-6.6H4.5a.9.9 0 010-1.8h6.6V4.5a.9.9 0 011.8 0v6.6h6.6l.092.005a.9.9 0 010 1.79l-.092.005h-6.6v6.6a.9.9 0 01-1.8 0z" fill="currentColor"></path>
                           </svg>
                  ...
                  <div class="faq-item-widget dark  mb-m w-full rounded-[10px] px-xl py-m mobile:bg-inherit last:mb-[0px] mobile:mb-[0px] mobile:px-[0px] mobile:py-[16px]">
                     <div class="flex cursor-pointer items-center ">
                        ...
                        <h2 class="mr-m flex-1 text-headline6 text-PrimaryText mobile:t-subtitle6 mobile:font-normal">How to track cryptocurrency prices</h2>
                        <div>
                           <svg class="bn-svg mobile:mx-[8px]" style="font-size:20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1 19.5v-6.6H4.5a.9.9 0 010-1.8h6.6V4.5a.9.9 0 011.8 0v6.6h6.6l.092.005a.9.9 0 010 1.79l-.092.005h-6.6v6.6a.9.9 0 01-1.8 0z" fill="currentColor"></path>
                           </svg>
                  ...
                  <div class="faq-item-widget dark  mb-m w-full rounded-[10px] px-xl py-m mobile:bg-inherit last:mb-[0px] mobile:mb-[0px] mobile:px-[0px] mobile:py-[16px]">
                     <div class="flex cursor-pointer items-center ">
                        ...
                        <h2 class="mr-m flex-1 text-headline6 text-PrimaryText mobile:t-subtitle6 mobile:font-normal">How to trade cryptocurrencies on Binance</h2>
                        <div>
                           <svg class="bn-svg mobile:mx-[8px]" style="font-size:20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1 19.5v-6.6H4.5a.9.9 0 010-1.8h6.6V4.5a.9.9 0 011.8 0v6.6h6.6l.092.005a.9.9 0 010 1.79l-.092.005h-6.6v6.6a.9.9 0 01-1.8 0z" fill="currentColor"></path>
                           </svg>
                  ...
                  <div class="faq-item-widget dark  mb-m w-full rounded-[10px] px-xl py-m mobile:bg-inherit last:mb-[0px] mobile:mb-[0px] mobile:px-[0px] mobile:py-[16px]">
                     <div class="flex cursor-pointer items-center ">
                        ...
                        <h2 class="mr-m flex-1 text-headline6 text-PrimaryText mobile:t-subtitle6 mobile:font-normal">How to earn from crypto on Binance</h2>
                        <div>
                           <svg class="bn-svg mobile:mx-[8px]" style="font-size:20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1 19.5v-6.6H4.5a.9.9 0 010-1.8h6.6V4.5a.9.9 0 011.8 0v6.6h6.6l.092.005a.9.9 0 010 1.79l-.092.005h-6.6v6.6a.9.9 0 01-1.8 0z" fill="currentColor"></path>
                           </svg>
               ...
               <footer class="hidden-in-bnc-app footer-wrapper dark-color common-widget-css_wrap theme-root">
                  ...
                  <div class="footer-copyright">
                     ...
                     <div class="footer-copyright-text footer-copyright-enterprise typography-Caption2">
                        ...
                        <span class="footer-copyright-cookieprefrence" data-ot-trigger="true">Cookie Preferences</span>
                     </div>
                  </div>
               </footer>
            </div>
        ...
        "i18nResource": {
            "en": {
                "LocalHomepage": {
                    ...
                    "homepage-forbes-2025": "Recognized as Forbes' Most Trusted Crypto Exchanges 2025",
                    "homepage-fortune-2025": "Listed #1 in Fortune's FinTech Innovators Asia 2024 in Blockchain & Crypto",
                    "homepage-cnbc-2025": "Named CNBC's World's Top Fintech Companies 2025 in Digital Tài sản",
