    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <a class="btn btn-outline-warning btn-label waves-effect waves-light" href="{{ route('client.profile.show', ['tab' => 'deposit']) }}"><i class="bx bx-money label-icon align-middle fs-16 me-2"></i> Nạp Tiền</a>
                </div>
