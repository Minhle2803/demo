                    ...
                    <div class="tab-pane {{ $activeTab === 'profile' ? 'active' : '' }}" id="personalDetails" role="tabpanel">
                        <form action="{{ route('client.profile.update') }}" method="POST" id="profileForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="nicknameInput" class="form-label">{{ __('messages.profile.nickname') }} </label>
                                        <input type="text" class="form-control" value="{{ old('nickname', $user->nickname) }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                ...
                                @if (!$user->isKycVerified())
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="custom-file-input-wrapper">
                                                <input type="file" class="custom-file-input" name="kyc_front" id="kycFrontInput" accept="image/*">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="custom-file-input-wrapper">
                                                <input type="file" class="custom-file-input" name="kyc_back" id="kycBackInput" accept="image/*">
