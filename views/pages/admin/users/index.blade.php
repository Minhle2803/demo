                        ...
                        <tbody>
                            @forelse ($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->created_at->timezone('Asia/Ho_Chi_Minh')->format('Y-m-d H:i') }}</td>
                                    <td>
                ...
                <div class="d-flex justify-content-end mt-3">
                    <div class="pagination-wrap hstack gap-2" style="margin-right: 50px;">
                        <?php
                            ...
                            $disabledPrev = $users->onFirstPage() ? 'disabled' : '';
                            $hrefPrev = $users->onFirstPage() ? '#' : $users->previousPageUrl();

                            $disabledNext = $users->hasMorePages() ? '' : 'disabled';
                            $hrefNext = $users->hasMorePages() ? $users->nextPageUrl() : '#';
                        ?>
