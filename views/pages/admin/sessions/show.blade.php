        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="row g-4 align-items-center">
                    <div class="col-sm-3">
                        <form method="GET" action="{{ route('admin.sessions.show', $session->id) }}">
                    ...
                    <table class="table align-middle table-nowrap">
                        ...
                        <tbody>
                            @forelse ($trades as $trade)
                                <tr>
                                    <td>{{ $trade->id }}</td>
                                    <td>{{ $trade->user->nickname }}</td>
                                    <td>
                                        @if ($trade->user)
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h6 class="mb-0 fs-13">{{ $trade->user->full_name ?? $trade->user->nickname ?? 'N/A' }}</h6>
