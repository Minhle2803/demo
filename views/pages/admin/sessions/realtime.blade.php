...
@section('title', 'Realtime Sessions')

@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0">Realtime Sessions</h4>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-auto">
                        <form method="GET" action="{{ route('admin.sessions.index') }}" class="d-flex gap-2 flex-wrap">
                            <input type="hidden" name="session_type" value="realtime">
                            ...
                            <input type="date" class="form-control form-control-sm w-auto" name="from" value="{{ request('from') }}" onchange="this.form.submit()">

                            <input type="date" class="form-control form-control-sm w-auto" name="to" value="{{ request('to') }}" onchange="this.form.submit()">
                        </form>
                    </div>
                    <div class="col-sm-auto ms-auto">
                        <a href="{{ route('admin.sessions.index') }}" class="btn btn-sm btn-soft-primary">View Future Sessions</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive table-card">
                    <table class="table align-middle table-nowrap">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="11" class="text-center text-muted py-3">No realtime sessions found.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
