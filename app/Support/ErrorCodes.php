...
final class ErrorCodes
{
    ...
    // Spot Trading
    const SPOT_ORDER_CREATED = 'SPOT_ORDER_CREATED';

    const SPOT_ORDER_CANCELLED = 'SPOT_ORDER_CANCELLED';

    const SPOT_INVALID_SYMBOL = 'SPOT_INVALID_SYMBOL';

    const SPOT_INVALID_PRICE = 'SPOT_INVALID_PRICE';

    const SPOT_INVALID_QUANTITY = 'SPOT_INVALID_QUANTITY';

    const SPOT_MIN_NOTIONAL_NOT_MET = 'SPOT_MIN_NOTIONAL_NOT_MET';

    const SPOT_INSUFFICIENT_BALANCE = 'SPOT_INSUFFICIENT_BALANCE';

    const SPOT_ORDER_NOT_FOUND = 'SPOT_ORDER_NOT_FOUND';

    const SPOT_ORDER_ALREADY_FILLED = 'SPOT_ORDER_ALREADY_FILLED';

    const SPOT_ORDER_ALREADY_CANCELLED = 'SPOT_ORDER_ALREADY_CANCELLED';

    const SPOT_ORDER_CANCEL_FAILED = 'SPOT_ORDER_CANCEL_FAILED';

    const SPOT_MATCH_FAILED = 'SPOT_MATCH_FAILED';

    const SPOT_ADMIN_MATCH_SUCCESS = 'SPOT_ADMIN_MATCH_SUCCESS';

    const SPOT_ADMIN_MATCH_FAILED = 'SPOT_ADMIN_MATCH_FAILED';

    const SPOT_UNAUTHORIZED = 'SPOT_UNAUTHORIZED';

    const SPOT_USER_NOT_FULLY_VERIFIED = 'SPOT_USER_NOT_FULLY_VERIFIED';

    const SPOT_WALLET_NOT_FOUND = 'SPOT_WALLET_NOT_FOUND';

    const SPOT_NEGATIVE_BALANCE_BLOCKED = 'SPOT_NEGATIVE_BALANCE_BLOCKED';
}
